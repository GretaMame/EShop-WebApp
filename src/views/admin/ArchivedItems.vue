  ...
  <div class="items-table">
    <el-container v-loading="loading">
      ...
      <el-main class="table-div">
        <el-table ref="itemTable" :data="items" :stripe="true" size="medium" :fit="true" :header-cell-style="headerCellStyle()" @selection-change="handleSelectionChange">
    ...
    methods: {
      ...
      fetchData () {
        ...
        var rowsPromise = this.axios.get(
          `odata/AdminItems?$count=true&$top=0${filterText ? `&$filter=${filterText}` : ''}`)
